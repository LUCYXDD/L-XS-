...
rizoel = "✯ LUCY X SPAM IS HERE ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **LUCYXsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await Riz.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/ ABOUTT_LUCYY"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/SECRET_xCITY")
        ],
        [
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "**Restarting Your Lucy X Spam**.. Please Wait Until It Starts Again"
